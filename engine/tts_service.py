...
async def synthesize_speech(text_chunk, index, semaphore, output_path):
    """
...
async def process_chunks_parallel(chunks, output_dir):
    """
        The Orchestrator: Splits all chunks into parallel tasks and executes them.
    ...
    for index, chunk in enumerate(chunks):
        ...
        # 2. Pass all 4 required arguments to the worker
        tasks.append(synthesize_speech(chunk, index, semaphore, chunk_path))
